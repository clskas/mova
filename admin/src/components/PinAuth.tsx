      ...
      <div className="grid grid-cols-3 gap-2 max-w-[260px] mx-auto">
        {keys.map((key, i) => (
          <button
            ...
            className="h-14 min-w-0 overflow-visible rounded-xl bg-white border border-gray-100 shadow-sm text-xl font-semibold text-[#1A1A2E] disabled:opacity-0 flex items-center justify-center px-2"
          >
            {key === "back" ? (
              <svg
                viewBox="0 0 24 24"
...
export function PinSetupForm({ apiBase, token, onDone, reset }: PinSetupProps) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-semibold text-center text-mova-midnight">
