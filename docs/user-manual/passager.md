...
2. **Écran d'accueil animé** (~12 s) : présentation des services (taxi, livraisons, wallet, etc.). Appuyez sur **Passer** ou touchez l'écran pour aller directement à la connexion.
