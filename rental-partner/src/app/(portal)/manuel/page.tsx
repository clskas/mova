...
const CHAPTERS = [
  {
    ...
    steps: [
      ...
      "Après la première connexion (Google ou téléphone), si le PIN KYC a déjà été envoyé, la fenêtre « Code PIN de connexion » (6 chiffres) s'affiche. Tableau de bord et réservations restent bloqués tant qu'il n'est pas saisi.",
      "Si le dossier n'est pas encore validé, ouvrez Mon dossier pour envoyer les justificatifs. Quand SENGA valide, un PIN à 6 chiffres arrive par e-mail : saisissez-le dans la même fenêtre.",
