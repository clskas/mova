  ...
  return (
    <div className="space-y-1.5">
      <button
        ...
        className={
          className ??
          "w-full py-2 rounded-xl border border-indigo-200 text-indigo-700 text-sm font-medium disabled:opacity-60 flex items-center justify-center gap-2 hover:bg-indigo-50"
        }
      >
