...
const PRIMARY_ORDER = ["/dashboard", "/", "/menu", "/catalogue", "/earnings"];
        ...
        <div className="px-3 sm:px-4 py-2.5 flex flex-col items-center gap-2">
          <div data-brand className="flex flex-col items-center gap-1">
            ...
            <div className="flex flex-wrap items-center justify-center gap-1.5 mt-0.5">
              ...
              {liveConnected && (
                <span className="text-[10px] uppercase tracking-wide px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 font-semibold ring-1 ring-emerald-100">
                  En direct
                </span>
              )}
            </div>
