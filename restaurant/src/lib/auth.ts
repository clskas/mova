...
const PIN_CONFIRMED_KEY = "mova_restaurant_login_pin_confirmed";
const EXPECT_PIN_KEY = "mova_restaurant_expect_pin";
const GOOGLE_SIGNED_OUT_KEY = "mova_restaurant_google_signed_out";
