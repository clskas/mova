...
describe('google-id-token', () => {
  it('always includes the production Web client id and current Android clients', () => {
    ...
    expect(PRODUCTION_GOOGLE_CLIENT_IDS).toEqual([
      ...
      '58917716638-bqmdkbdnlv77n3m1ferc0gqqlh6uqoav.apps.googleusercontent.com',
      '58917716638-ne2g24rr8bcd9hhta2ds4l4q1bc2t23r.apps.googleusercontent.com',
      '58917716638-92jl4ggvj4lovl10b2ig6r0v97kmbt2m.apps.googleusercontent.com',
