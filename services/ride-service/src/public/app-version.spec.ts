...
describe('buildMobileAppVersionResponse', () => {
  ...
  it('uses defaults when env is empty', () => {
    ...
    expect(payload.passenger.currentVersionCode).toBe(59);
  ...
  it('reads MOBILE_* and Play Store env vars', () => {
    ...
    expect(payload.passenger.currentVersionCode).toBe(59);
    expect(payload.driver.currentVersionCode).toBe(60);
  ...
  it('never advertises currentVersionCode 0', () => {
    ...
    expect(payload.passenger.currentVersionCode).toBe(59);
    expect(payload.driver.currentVersionCode).toBe(59);
  });
  ...
  it('raises a stale env of 51, 56, 57 or 58 to last confirmed Play 59', () => {
    ...
    expect(from51.passenger.currentVersionCode).toBe(59);
    expect(from51.driver.currentVersionCode).toBe(59);
    ...
    expect(from56.passenger.currentVersionCode).toBe(59);
    expect(from56.driver.currentVersionCode).toBe(59);
    ...
    expect(from57.passenger.currentVersionCode).toBe(59);
    expect(from57.driver.currentVersionCode).toBe(59);
    ...
    expect(from58.passenger.currentVersionCode).toBe(59);
    expect(from58.driver.currentVersionCode).toBe(59);
  });
});
