...
describe('buildMobileAppVersionResponse', () => {
  ...
  it('uses defaults when env is empty', () => {
    ...
    expect(payload.passenger.currentVersionCode).toBe(56);
  ...
  it('never advertises currentVersionCode 0', () => {
    ...
    expect(payload.passenger.currentVersionCode).toBe(56);
    expect(payload.driver.currentVersionCode).toBe(56);
  });
  ...
  it('raises a stale env of 51 to last confirmed Play 56', () => {
    const payload = buildMobileAppVersionResponse(
      {
