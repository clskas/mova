 ...
 * versionCode floor is last confirmed Play production (`1.0.6+51`,
 * Mobile Release 34132509908 — internal upload then promote to production).
...
const CURRENT_VERSION_CODE_FLOOR = 51;
