 ...
 * versionCode floor is last confirmed Play production (`1.0.6+57`,
 * Mobile Release 34213561877 — internal then promote to production).
...
const CURRENT_VERSION_CODE_FLOOR = 57;
