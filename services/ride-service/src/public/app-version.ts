 ...
 * versionCode floor is last confirmed Play production (`1.0.6+58`,
 * Mobile Release 34223352006 — internal then promote to production).
...
const CURRENT_VERSION_CODE_FLOOR = 58;
