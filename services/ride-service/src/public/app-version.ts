 ...
 * versionCode floor is last confirmed Play production (`1.0.6+63`,
 * Mobile Release 34255560335 — pubspec 1.0.7+60, run_number 63,
 * internal then promote to production).
...
const CURRENT_VERSION_CODE_FLOOR = 63;
