 ...
 * versionCode floor is last confirmed Play production (`1.0.6+59`,
 * Mobile Release 34239073588 — internal then promote to production).
...
const CURRENT_VERSION_CODE_FLOOR = 59;
